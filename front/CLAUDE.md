...
The backend API contract for this front is documented in `../docs/backend/api_frontend.md`.
...
- Roadmap of pending work and conventions is tracked in `../docs/frontend/roadmap.md`.
